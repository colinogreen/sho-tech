...
<div class="row"> <!-- index row | START -->
    <div class="col-12 order-2 order-sm-1">
        <h3 id="index-title">A website that showcases Colin's skills in web design.<br>Technologies used include JavaScript, PHP, React.js, HTML, CSS and JQuery</h3>
    ...
    <div class="col-12 order-1 order-sm-2">
        <p class="d-md-none d-block"><a href="#index-title">more info ...</a></p>
